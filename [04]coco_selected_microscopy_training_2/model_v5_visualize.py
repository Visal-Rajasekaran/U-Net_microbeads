...
def visualize_outputs(model_path, dataset, index=0, device='cuda',type=None):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_FOLDER,"fft_model_v4_seg_only",f"Model_v4_fft_{type}_{index}.png"))
...
model_path = os.path.join(BASE_DIR, "weights_fft_new_microscopy_model_v5_seg_only.pth")

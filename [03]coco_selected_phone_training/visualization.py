...
def visualize_outputs(model_path, dataset, index=0, device='cuda'):
    ...
    plt.tight_layout()
    plt.savefig("PlotwoA_1.png")

    num_peaks = count_local_maxima(seg_np, threshold=0.1)
    print("Detected centroids:", num_peaks)
...
model_path = os.path.join(BASE_DIR, "weights_phone.pth")

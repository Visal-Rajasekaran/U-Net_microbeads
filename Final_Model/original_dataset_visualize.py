...
#RESULTS_FOLDER = os.path.join(BASE_DIR, "synthetic_data_generation", "sdg_5_model_v7_deepgatewith2convolution_dense_test_on_original_results")

IMAGE_FOLDER = os.path.join(BASE_DIR, "video_frames_512")
RESULTS_FOLDER = os.path.join(BASE_DIR, "Final_Model","Modified_Video")
...
# Load model
model_path = os.path.join(BASE_DIR, "weights_outputs", "weights_sdg_5_model_v7_att_dense.pth")

...
if __name__ == "__main__":
    BASE_DIR = BASE_DIR = Path(__file__).resolve().parents[1]
    IMAGE_FOLDER = os.path.join(BASE_DIR,"dataset", "selected_80x")
    generate_cvat_xml(IMAGE_FOLDER, output_file=os.path.join(BASE_DIR,"label_generation","ellipses_cvat_80x.xml"))

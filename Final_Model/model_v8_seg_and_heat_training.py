...
IMAGE_FOLDER = os.path.join(BASE_DIR, "synthetic_data_generation","synthetic_images_5_low_dense" )
RESULTS_FOLDER = os.path.join(BASE_DIR, "synthetic_data_generation")
#CENTROIDS_FOLDER = os.path.join(BASE_DIR, "dataset", "centroids")
MASKS_FOLDER = os.path.join(BASE_DIR, "synthetic_data_generation", "masks_5_low_dense")
...
# Dataset
full_dataset = CentroidDataset(os.path.join(RESULTS_FOLDER,"synthetic_images_5_low_dense", 'synthetic_centroids_5_low_dense.csv'), IMAGE_FOLDER, MASKS_FOLDER)
...
for epoch in range(max_epochs):
    ...
    if val_loss_avg < best_val_loss:
        ...
        best_model_wts = copy.deepcopy(model.state_dict())
        torch.save(best_model_wts, "../weights_outputs/weights_sdg_5_model_v8_heat_and_seg_low_dense.pth")

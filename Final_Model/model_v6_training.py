...
IMAGE_FOLDER = os.path.join(BASE_DIR, "fft_0.9_selected")
...
for epoch in range(max_epochs):
    ...
    for batch in train_loader:
        ...
        loss, l_heat = criterion(heat_pred, heatmap_target)
    ...
    with torch.no_grad():
        for batch in val_loader:
            ...
            val_loss, _ = criterion(heat_pred, heatmap_target)
    ...
    if val_loss_avg < best_val_loss:
        ...
        best_model_wts = copy.deepcopy(model.state_dict())
        torch.save(best_model_wts, "weights_fft_new_microscopy_model_v6_0.2.pth")

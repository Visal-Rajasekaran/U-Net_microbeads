...
from loss_v7_att import *
from model_v7_deepgate import *
...
IMAGE_FOLDER = os.path.join(BASE_DIR, "synthetic_data_generation","synthetic_images_4" )
RESULTS_FOLDER = os.path.join(BASE_DIR, "synthetic_data_generation")
#CENTROIDS_FOLDER = os.path.join(BASE_DIR, "dataset", "centroids")
MASKS_FOLDER = os.path.join(BASE_DIR, "synthetic_data_generation", "masks_4")
...
# Dataset
full_dataset = CentroidDataset(os.path.join(RESULTS_FOLDER,"synthetic_images_4", 'synthetic_centroids_4.csv'), IMAGE_FOLDER, MASKS_FOLDER)
...
for epoch in range(max_epochs):
    ...
    if val_loss_avg < best_val_loss:
        ...
        best_model_wts = copy.deepcopy(model.state_dict())
        torch.save(best_model_wts, "../weights_outputs/weights_sdg_4_model_v7_deepgate.pth")

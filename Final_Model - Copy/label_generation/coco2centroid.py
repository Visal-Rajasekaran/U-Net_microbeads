...
COCO_JSON_PATH = os.path.join(BASE_DIR,"label_generation", "annotations_final.json")
IMAGE_FOLDER = os.path.join(BASE_DIR, "dataset", "images_selected")
RESULTS_FOLDER = os.path.join(BASE_DIR, "results","labels")

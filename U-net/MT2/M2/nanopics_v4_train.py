...
IMAGE_FOLDER = os.path.join(BASE_DIR, "grayscale_norm_selected_split","more_than_300")
RESULTS_FOLDER = os.path.join(BASE_DIR, "results")
#CENTROIDS_FOLDER = os.path.join(BASE_DIR, "dataset", "centroids")
MASKS_FOLDER = os.path.join(BASE_DIR, "dataset", "masks_dense")
...
# Dataset
full_dataset = CentroidDataset(os.path.join(RESULTS_FOLDER, 'dense_centroids.csv'), IMAGE_FOLDER, MASKS_FOLDER)
...
for epoch in range(max_epochs):
    ...
    if val_loss_avg < best_val_loss:
        ...
        best_model_wts = copy.deepcopy(model.state_dict())
        torch.save(best_model_wts, "weights_grayscale_norm_dense_model_v4_0.2.pth")
